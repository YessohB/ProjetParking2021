...
<div class="container"> 
 <div class="alert alert-warning" role="alert-warning">
   Veuillez à respecter les gestes barrières pour lutter contre le Covid-19
 </div>
</div>
</section>
...
<br>
  ...
  <div class="container">
    <div class="row">
      <div class="col">
        <h1>Présent déjà dans 10 métropoles françaises </h1>
      </div>
    </div> 
        ...
        <div id="carouselControls" class="carousel slide" data-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="images/métropoles/bordeaux.jpg" class="d-block w-100" alt="Bordeaux">
            </div>
            <div class="carousel-item">
              <img src="images/métropoles/lille.jpg" class="d-block w-100" alt="Lille">
            </div>
            <div class="carousel-item">
              <img src="images/métropoles/nantes.jpg" class="d-block w-100" alt="Nantes">
            </div>
            <div class="carousel-item">
              <img src="images/métropoles/paris.jpeg" class="d-block w-100" alt="Paris">
            </div>
          </div>
      ...
      <div class="col-12 col-lg-4">
        <div class="card mb-4 mb-lg-0 border-primary shadow">
          <div class="card-body">
            ...
            <p class="card-text">Cette première étape consiste en une ...</p>
          </div>
        </div>
      </div>
      <div class="col-12 col-lg-4">
        <div class="card mb-4 mb-lg-0 border-primary shadow">
          <div class="card-body">
            ...
            <p class="card-text">Cette deuxième a pour objectif de ...</p>
          </div>
        </div>
      </div>
      <div class="col-12 col-lg-4">
        <div class="card mb-4 mb-lg-0 border-primary shadow">
          <div class="card-body">
            ...
            <p class="card-text">Cette troisième a pour objectif de ...</p>
          </div>
        </div>
      </div>
    </div>
